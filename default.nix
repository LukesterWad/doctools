...
stdenv.mkDerivation {
  ...
  installPhase = ''
    ...
    cp ./autocomplete/doctools.autocomplete.bash $out/share/bash-completion/completions/dt
    mkdir -p $out/share/fish/vendor_completions.d
    cp ./autocomplete/doctools.autocomplete.fish $out/share/fish/vendor_completions.d/dt.fish
  '';
}
